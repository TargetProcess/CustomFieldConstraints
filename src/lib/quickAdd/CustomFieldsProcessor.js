...
var CustomFieldsProcessor = Processor.extend({
    ...
    _getNewAxisValue: function(axisValue, axisAction) {
        return {
            name: axisValue.substring(3),
            value: this.sliceDecoder.decode(axisAction)
        };
    },
            ...
            entity: {
                ...
                customFields: _.map(customFields, function(customField) {
                    return {
                        ...
                        value: customField.config.defaultValue
                    };
                })
            },
...
module.exports = CustomFieldsProcessor;
